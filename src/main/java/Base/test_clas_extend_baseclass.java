...
public class test_clas_extend_baseclass extends baseclass{
	...
	public void loginToApp() throws Throwable {
		//enter un
		 ...
		 Object Utility_class = null;
		login1.enterUN(((Utility) Utility_class).getTD(0, 0));//DPG458
		 System.out.println((((Utility) Utility_class).getTD(0, 0)));
		 
		 //enter pwd
		
		login1.enterPWD(((Utility) Utility_class).getTD(0, 1));
		//clck on login btn
		login1.clickLOGINBTN();
		
		//enter pin
		
		login2.enterPIN(((Utility) Utility_class).getTD(0, 2));
